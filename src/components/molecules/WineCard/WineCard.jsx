...
export const WineCard = ({ wine, showEditDelete = false, onEdit, onDelete }) => {
  ...
  return (
    <div className="card card-side bg-base-100 shadow-xl px-6 py-0 m-0 w-full h-auto md:w-[768px] md:h-[400px] mx-auto rounded-lg flex flex-col md:flex-row items-stretch mt-8 transform transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl">
